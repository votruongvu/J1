...
_GROUNDING_PROMPT = (
    ...
    "claims. The answer must rely only on the cited sources. List "
    "any factual statement in the answer that isn't supported by "
    "any of the citations, with severity:\n"
