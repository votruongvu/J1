...
- [docs/11-ingestion-execution-profiles.md](docs/11-ingestion-execution-profiles.md) — One user-facing profile (`knowledge_index`) plus three capability checkboxes (Process images / tables / equations). Legacy wire values (`minimum_queryable` / `standard` / `advanced`) accepted for replay compat.
